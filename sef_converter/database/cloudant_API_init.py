...
client = CloudantV1.new_instance(service_name="SEF_FORMAT")
...
# 5. Get document out of the database by document id ============
document_about_zebra = client.get_document(
    db=db_name,
    doc_id="a16340233c1825ebcb3ab82fcdb9eaaf"
).get_result()
